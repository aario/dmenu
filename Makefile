...
dist: clean
	...
	@cp LICENSE Makefile README arg.h config.def.h config.mk dmenu.1 \
		drw.h util.h dmenu_path dmenu_run dmenu_win dmenu_vol dmenu_media dmenu_custom dmenu_home dmenu_apps stest.1 ${SRC} \
		dmenu-${VERSION}
...
install: all
	...
	@cp -f dmenu dmenu_path dmenu_run dmenu_win dmenu_vol dmenu_media dmenu_custom dmenu_home dmenu_apps stest ${DESTDIR}${PREFIX}/bin
